...
public class UserController extends MultiActionController {
	public ModelAndView login(HttpServletRequest request, HttpServletResponse response)throws Exception{
		String userID="";
		String passwd="";
		String viewName =getViewName(request); //uri를 통해 요청명을 가져옴
		...
		System.out.println("요청명 : "+ viewName);
		return mav;
	...
	private  String getViewName(HttpServletRequest request) throws Exception { //uri를 이용하여 요청명을 구하는 메소드
	      ...
	      int begin = 0;  //
	      if(!((contextPath==null)||("".equals(contextPath)))){//contextPath가 null이 아니라면..
